...
class Coin_box(pg.sprite.Sprite):
    ...
    def get_image(self, x, y, width, height):
        ...
        image = pg.transform.scale(image,
                                   (int(rect.width*s.BRICK_SIZE_MULTIPLIER),
                                    int(rect.height*s.BRICK_SIZE_MULTIPLIER)))
        return image
    ...
    def setup_frames(self):
        """Create frame list"""
        self.frames.append(
            self.get_image(384, 96, 16, 16))
        self.frames.append(
            self.get_image(400, 96, 16, 16))
        self.frames.append(
            self.get_image(416, 96, 16, 16))
        self.frames.append(
            self.get_image(432, 96, 16, 16))
