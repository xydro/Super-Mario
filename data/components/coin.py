...
class Coin(pg.sprite.Sprite):
    ...
    def setup_frames(self):
        ...
        self.frames.append(self.get_image(145, 160, 5, 8))
        self.frames.append(self.get_image(153, 160, 5, 8))
        self.frames.append(self.get_image(161, 160, 5, 8))
        self.frames.append(self.get_image(145, 160, 5, 8))
