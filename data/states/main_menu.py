...
class Menu(tools._State):
    ...
    def startup(self, current_time, persist):
        ...
        self.overhead_info = info.OverheadInfo(self.game_info, s.MAIN_MENU)
    ...
    def setup_background(self):
        ...
        self.background = pg.transform.scale(self.background,
                                   (int(self.background_rect.width*s.BACKGROUND_MULTIPLER),
                                    int(self.background_rect.height*s.BACKGROUND_MULTIPLER)))
    ...
    def update(self, surface, keys, current_time):
        ...
        self.game_info[s.CURRENT_TIME] = self.current_time
    ...
    def update_cursor(self, keys):
        ...
        if self.cursor.state == s.PLAYER1:
    ...
    def reset_game_info(self):
        ...
        self.game_info[s.COIN_TOTAL] = 0
        self.game_info[s.SCORE] = 0
        self.game_info[s.LIVES] = 3
        self.game_info[s.CURRENT_TIME] = 0.0
        self.game_info[s.LEVEL_STATE] = None
